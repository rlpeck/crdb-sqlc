...
// toolName returns the name shown in the generated "Code generated by ..."
// header. CockroachDB output is branded crdb-sqlc; all other engines keep sqlc.
func toolName(req *plugin.GenerateRequest) string {
	if req.Settings != nil && req.Settings.Engine == "cockroachdb" {
		return "crdb-sqlc"
	}
	return "sqlc"
}
